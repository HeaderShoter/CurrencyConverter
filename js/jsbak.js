...
let sellValue = document.querySelector(".js-form_input-sell");
let chargeValue = document.querySelector(".js-form_input-charge");
let sellType = document.querySelector(".js-form_selectCurrency-sell");
let chargeType = document.querySelector(".js-form_selectCurrency-charge");
